 ...
 * other values with those—it just tracks which values are part of the set. A value can be part of
...
class Group {
  ...
  static from(arr) {
    const group = new Group(); // not a fan of how often group is written
